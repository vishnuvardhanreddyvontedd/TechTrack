  ...
  return (
    <aside className="hidden md:flex flex-col w-60 shrink-0 h-screen sticky top-0 bg-[--bg-surface] overflow-hidden">
      ...
      <div className="flex items-center gap-3 px-5 py-6">
        <div className="w-9 h-9 rounded-xl gradient-brand flex items-center justify-center shadow-lg glow-brand flex-shrink-0">
        ...
        <div>
          <span className="text-base font-bold gradient-text">TechTrack</span>
