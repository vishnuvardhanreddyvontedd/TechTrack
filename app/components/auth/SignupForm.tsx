...
// Client Component — drives the signup Server Action via useActionState.
// Displays field-level validation errors returned from the Server Action.
...
export default function SignupForm() {
  ...
  return (
    ...
    >
      {/* Top message (server-level errors) */}
      {state?.message && (
        <motion.div
      ...
      <form action={action} className="space-y-4">
        ...
        {state?.errors?.password && (
          <ul className="text-xs text-red-400 space-y-0.5 pl-4 list-disc">
